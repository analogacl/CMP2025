        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-gray-300 mb-8 max-w-xl mx-auto lg:mx-0">
              Maximiza el valor de tu tráfico web con estrategias de CRO basadas en datos que aumentan conversiones y
              potencian tus ingresos
            </p>
          ...
          >
            <div className="relative rounded-lg overflow-hidden shadow-2xl border border-gray-800">
              ...
              <Image
                src="/cro-dashboard-analytics.png"
                alt="Dashboard de Optimización de Conversiones"
                width={800}
                height={600}
            ...
            <div className="absolute -top-6 -right-6 bg-gradient-to-r from-blue-600/20 to-primary/20 p-4 rounded-lg backdrop-blur-sm border border-white/10 shadow-xl hidden md:block">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-medium">Aumento promedio</p>
                  <p className="text-green-500 font-bold">+135%</p>
                </div>
              </div>
            </div>
            ...
            <div className="absolute -bottom-6 -left-6 bg-gradient-to-r from-blue-600/20 to-primary/20 p-4 rounded-lg backdrop-blur-sm border border-white/10 shadow-xl hidden md:block">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-blue-500 font-bold">+280%</p>
                </div>
              </div>
            </div>
          </motion.div>
      ...
      {showForm && (
        ...
        >
          <div className="bg-gray-900 border border-gray-800 rounded-lg p-6 max-w-md w-full">
            <h3 className="text-xl font-bold mb-4">Solicita tu auditoría CRO gratuita</h3>
            <p className="text-gray-400 mb-6">
              Completa el formulario y te enviaremos un análisis detallado de las oportunidades de optimización en tu
              sitio web.
            </p>
            <form className="space-y-4">
              ...
              <div>
                <label htmlFor="message" className="block text-sm font-medium mb-1">
                  ¿Cuál es tu principal desafío de conversión?
                </label>
                <textarea
                  id="message"
                  className="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-md focus:outline-none focus:ring-2 focus:ring-primary"
                  placeholder="Ej: Bajo ratio de conversión en checkout, alto abandono de carrito..."
                  rows={3}
                />
              </div>
