...
export default function CROCTA() {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            <motion.div variants={itemVariants} className="p-8 md:p-12">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-6">
                Maximiza tus Conversiones con{" "}
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-primary to-blue-500">Analoga</span>
              </h2>
              <p className="text-gray-300 mb-8">
                ¿Listo para transformar tu tasa de conversión y potenciar tus resultados? Solicita una auditoría CRO
                gratuita y descubre oportunidades de optimización específicas para tu sitio web.
              </p>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-gray-300">Análisis detallado de tu embudo de conversión</p>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-primary/20 flex items-center justify-center flex-shrink-0 mt-1">
                    <Check className="w-4 h-4 text-primary" />
                  </div>
                  <p className="text-gray-300">Identificación de oportunidades de mejora inmediatas</p>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-primary/20 flex items-center justify-center flex-shrink-0 mt-1">
                    <Check className="w-4 h-4 text-primary" />
                  </div>
                  <p className="text-gray-300">Recomendaciones personalizadas basadas en datos</p>
                </div>
              </div>
