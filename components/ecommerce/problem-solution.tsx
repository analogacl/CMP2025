    ...
    <section className="py-20 md:py-32 bg-gradient-to-b from-background to-gray-900/50" ref={ref}>
      <div className="container px-4">
          ...
          <motion.div variants={itemVariants} className="order-2 lg:order-1">
            <div className="relative rounded-lg overflow-hidden shadow-2xl border border-gray-800">
              <Image
                ...
                alt="Problemas comunes en tiendas Shopify"
                width={800}
                height={600}
          ...
          <motion.div variants={itemVariants} className="order-1 lg:order-2">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              ...
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-red-500 to-orange-500">
                tiendas Shopify convencionales
              </span>
            </h2>
            <div className="space-y-6 text-gray-300">
              <p>
                Las tiendas Shopify tradicionales enfrentan desafíos significativos que afectan directamente a tus
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-medium">Experiencia móvil subóptima</p>
                    <p className="text-sm text-gray-400">
                      Adaptaciones a móvil que son meras reducciones del diseño de escritorio, ignorando las necesidades
                      específicas de los usuarios móviles.
                    </p>
                  </div>
                </li>
              </ul>
        ...
        <div className="mt-24 text-center">
          ...
          >
            Nuestra{" "}
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-primary to-blue-500">solución</span>
          </motion.h2>
          <motion.p
            variants={itemVariants}
            initial="hidden"
          ...
          >
            Combinamos dos tecnologías líderes para crear tiendas Shopify que no solo se ven bien, sino que convierten
            mejor:
          </motion.p>
          ...
          >
            ...
            >
              ...
              <h3 className="text-xl font-bold mb-4">Shopify Hydrogen</h3>
              <p className="text-gray-400">
                Framework de React que permite crear experiencias de compra dinámicas y ultrarrápidas, optimizadas para
